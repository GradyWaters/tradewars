  ...
  try {
    ...
    for (let i = 0; i < newBots.length; i++) {
      ...
      const systemPrompt = bot.strategy === 'conservative' 
        ? `You are ${bot.name}, a conservative crypto trader. You avoid risk, buy dips cautiously, and take small profits. Never risk more than 30% of portfolio on one trade.`
